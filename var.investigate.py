...
name = "Nashita"
grade = 11
favourite_exclamation = "sis"
least_favourite_colour = "gray"
is_cool = True
math_test_score = 92
sister_name = "Arshi"
...
print(
    ...
    + f"Anyway, that's the story of my math test. Lowkey a weird day, but at least I went out with {friend} after. We went to {place} and got some {food}! It tasted funky, but overall good."
)
